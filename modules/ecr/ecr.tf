# ECR repositories for Traffic Tacos microservices
...
resource "aws_ecr_repository" "reservation_api" {
  ...
  tags = merge(var.tags, {
    ...
    Description = "Kotlin + Spring Boot WebFlux core reservation service"
  })
}
...
resource "aws_ecr_repository" "inventory_api" {
  ...
  tags = merge(var.tags, {
    ...
    Description = "Go + gRPC high-performance inventory management"
  })
}
...
resource "aws_ecr_repository" "payment_sim_api" {
  ...
  tags = merge(var.tags, {
    ...
    Description = "Go + gRPC payment processing simulator"
  })
}
...
resource "aws_ecr_repository" "reservation_worker" {
  ...
  tags = merge(var.tags, {
    ...
    Description = "Go/Kotlin Kubernetes Job + KEDA auto-scaling worker"
  })
}
